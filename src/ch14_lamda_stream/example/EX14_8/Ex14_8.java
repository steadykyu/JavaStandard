package ch14_lamda_stream.example.EX14_8;
...
class Exercise14_8 {
    public static void main(String[] args) {
        ...
        Stream.of(stuArr).collect(Collectors.partitioningBy(
                Student::isMale,
                Collectors.partitioningBy(s -> s.getScore() < 150, Collectors.counting())   // counting도 Collecotors의 static 메서드이다.
                )
        );
